 ...
 */
#ifndef ASCII_CONTROL_LOOK_H
#define ASCII_CONTROL_LOOK_H
...
class AsciiControlLook : public HaikuControlLook {
public:
								AsciiControlLook(image_id id);
	virtual						~AsciiControlLook();
	...
	protected:
			...
			void				_DrawAddonButtonBackground(BView* view, BRect& rect,
									...
									orientation orientation = B_HORIZONTAL);
	private:
			void				_DrawAsciiUpFrame(BView* view, BRect & rect, bool push);	
			

};


#endif	// ASCII_CONTROL_LOOK_H
