...
class HakiloControlLook : public HaikuControlLook {
public:
								HakiloControlLook(image_id id);
...
protected:
	...
	// Background gradient methods
			void				_FillNoGradient(BView* view, const BRect& rect,
									const rgb_color& base);	
			...
			void				_MakeNoGradient(BGradientLinear& gradient,
									const BRect& rect, const rgb_color& base) const;						
